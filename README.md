...
3. Z plików źródłowych zbuduj obraz o nazwie : `obraz:v5`.
4. Z obrazu uruchom kontener o nazwie `kontener` na porcie `4123:3000` (host:4123 → kontener:3000).
5. Sprawdź, czy aplikacja odpowiada (`curl -f http://localhost:4123/`). Jeśli wszystko działa to powinien sie wyświetlić kod HTML. 
